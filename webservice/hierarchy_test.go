...
func Test_Client_Hierarchy(t *testing.T) {
	...
	caller := func(client *Client) func(ctx context.Context, req HierarchyRequest) ([]GeoName, error) {
		return client.Hierarchy
	}

	testCases := []testSuite[HierarchyRequest, []GeoName]{
		{
