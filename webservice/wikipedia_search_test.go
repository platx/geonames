...
func Test_Client_WikipediaSearch(t *testing.T) {
	t.Parallel()

	caller := func(client *Client) func(ctx context.Context, req WikipediaSearchRequest) ([]Wikipedia, error) {
		return client.WikipediaSearch
	}

	testCases := []testSuite[WikipediaSearchRequest, []Wikipedia]{
		{
			...
			args: args[WikipediaSearchRequest]{
				ctx: context.Background(),
				req: WikipediaSearchRequest{
					Query:    "Foo",
					Title:    "Bar",
					Language: "en",
					MaxRows:  2,
