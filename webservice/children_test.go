...
func Test_Client_Children(t *testing.T) {
	t.Parallel()

	caller := func(client *Client) func(ctx context.Context, req ChildrenRequest) ([]GeoName, error) {
		return client.Children
	}

	testCases := []testSuite[ChildrenRequest, []GeoName]{
		{
