...
func Test_Client_Contains(t *testing.T) {
	t.Parallel()

	caller := func(client *Client) func(ctx context.Context, req ContainsRequest) ([]GeoName, error) {
		return client.Contains
	}

	testCases := []testSuite[ContainsRequest, []GeoName]{
		{
